<!--
 * @Author: kok-s0s
 * @Date: 2021-08-11 17:24:11
 * @LastEditors: kok-s0s
 * @LastEditTime: 2021-08-13 15:40:24
 * @Description: Node 和 Express 基础
-->
...
注意： extended 是一个配置选项, 告诉 body-parser 需要使用哪个解析。 当 extended=false 时，它使用经典编码 querystring 库。 当 extended=true时，它使用 qs 库进行解析。
